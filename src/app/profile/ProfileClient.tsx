      ...
      <div className="max-w-md mx-auto pt-2 px-4">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
          ...
          <div className="space-y-3">
            ...
            {user.username && (
              <div className="bg-gray-50 rounded-xl p-3">
                <label className="text-xs font-medium text-gray-500 uppercase tracking-wide">Telegram</label>
                <p className="text-base font-semibold text-gray-800 mt-1">@{user.username}</p>
              </div>
            )}
          </div>
