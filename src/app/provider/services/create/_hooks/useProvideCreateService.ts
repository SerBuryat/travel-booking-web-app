...
import {createService, NewServicePhoto} from "@/lib/service/createService";
...
export const useProvideCreateService = () => {
  ...
  const onSubmit = async (data: CreateServiceData, photos?: NewServicePhoto[], forceError?: boolean) => {
