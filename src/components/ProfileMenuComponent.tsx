...
export default function ProfileMenuComponent() {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      ...
      <button
        onClick={logout}
        className="w-full flex items-center gap-3 px-4 py-3 text-left hover:bg-red-50 transition-colors border-t border-gray-200"
      >
        ...
        <span className="font-bold text-red-600">Выйти из профиля</span>
      </button>
    </div>
  );
}
